package com.ppjt10.skifriend.initdata;
...
public class SkiFriendInitData implements ApplicationRunner {
    // park
    ...
    public void run(ApplicationArguments args) {
        ...
        Boolean isTestUser = userRepository.existsByUsername("skifriend1");
        if (!isTestUser) {
